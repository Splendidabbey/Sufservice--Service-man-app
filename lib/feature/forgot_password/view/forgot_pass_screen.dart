...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
  ...
  void _forgetPass(String countryDialCode,AuthController authController) async {
    String phone = VerifyPhoneHelper.getValidPhone(countryDialCode + _identityController.text.trim(), withCountryCode: true);
    ...
    if (_identityController.text.isEmpty && _forgetPasswordMethod == "email") {
      ...
      showCustomSnackBar('enter_email_address_or_phone_number'.tr);
    }
