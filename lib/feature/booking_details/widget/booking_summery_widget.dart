...
class BookingSummeryView extends StatelessWidget{
  ...
  const BookingSummeryView({super.key, required this.bookingDetailsContent}) ;
            ...
            child: Row(
              ...
              children: [
                ...
                Directionality(
                  ...
                  child: Text(
                      '(-) ${PriceConverter.convertPrice(bookingDetailsController.bookingDetailsContent!.totalReferralDiscountAmount ?? 0)}',
                      style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color!)),
                ),
              ],
            ),
