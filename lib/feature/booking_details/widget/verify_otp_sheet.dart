        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Column(children: [
              ...
              !bookingDetailsController.isWrongOtpSubmitted  && !bookingDetailsController.isUpdate ? Text('collect_otp_from_customer'.tr, style: ubuntuRegular, textAlign: TextAlign.center):
              const Text(""),
              const SizedBox(height: Dimensions.paddingSizeLarge),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              bookingDetailsController.hideResendButton ?  Padding(
                ...
                onTap: () async {
                  ...
                  if(resend){
                    showCustomSnackBar("otp_resend_successfully".tr, isError: false);
                  }else{
